/*
	Object that randomly spawns, is collected by player.
*/

CollectableCircle = function(id, radius, speedMax) {
...
CollectableCircle.prototype.update = function() {
	this.move();
};

CollectableCircle.prototype.move = function() {
...
CollectableCircle.prototype.draw = function() {
...
CollectableCircle.prototype.drawAtPos = function(x, y) {
	g_g.ctx.beginPath();
...
CollectableCircle.prototype.speedInc = function(value) {
	this.speed += value;
	if (this.speed > this.speedMax)
		this.speed = this.speedMax;
};

CollectableCircle.prototype.speedDec = function(value) {
	this.speed -= value;
	if (this.speed < 0)
		this.speed = 0;
};